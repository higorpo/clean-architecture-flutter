...
void main() {
  ...
  group('get', () {
    When mockRequest() => when(() => client.get(any(), headers: any(named: 'headers')));
  ...
  group('put', () {
    When mockRequest() => when(() => client.put(any(), headers: any(named: 'headers'), body: any(named: 'body')));
    ...
    test('Should return BadRequestError if put returns 400 with no data', () async {
      mockResponse(400, body: '');
