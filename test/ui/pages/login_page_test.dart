...
void main() {
  ...
  testWidgets('Should present no error if email is valid with empty string error', (WidgetTester tester) async {
    await loadPage(tester);
  ...
  testWidgets('Should present no error if password is valid with empty string error', (WidgetTester tester) async {
    await loadPage(tester);
