...
void main() {
  ...
  Future<void> loadPage(WidgetTester tester) async {
    ...
    final surveyResult = GetMaterialApp(
    ...
    await provideMockedNetworkImages(() async {
      await tester.pumpWidget(surveyResult);
    });
  }
  ...
  testWidgets('Should call LoadSurveyResult on reload button', (WidgetTester tester) async {
    await loadPage(tester);
